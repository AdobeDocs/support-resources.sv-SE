...
* Konfigurera regeluppsättningar för kanal/resa: Se [Arbeta med regeluppsättningar](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/conflict-prioritization/capping-rules/rule-sets).
