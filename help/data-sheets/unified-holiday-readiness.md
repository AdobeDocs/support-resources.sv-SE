...
## Guide för beredskap för helgdagar i Adobe Experience Platform (AEP)
...
## Guide för beredskap för helgdagar i Adobe Journey Optimizer (AJO)

+++**Klicka för att visa rekommendationer för Adobe Journey Optimizer (AJO) holdiay readiness (beredskap).**
...
* Konfigurera regeluppsättningar för kanaler/resor: [Arbeta med regeluppsättningar](https://experienceleague.adobe.com/sv/docs/journey-optimizer/using/conflict-prioritization/capping-rules/rule-sets).
...
## Guide för beredskap för helgdagar i Customer Journey Analytics (CJA)
...
## Beredskapshandbok för helgdagar i Adobe Commerce
...
## beredskapshandbok för Adobe Experience Manager (AEM) Cloud Services

+++**Klicka för att visa beredskapsrekommendationerna för Adobe Experience Manager (AEM) Cloud Services.**
...
## Adobe Marketo guide om beredskap för semester
...
## Beredskapshandbok för helgdagar i Adobe Workfront
...
## Beredskapshandbok för helgdagar i Adobe Campaign
...
## Beredskapshandbok för helgdagar i Adobe Analytics
...
## Beredskapshandbok för helgdagar i Adobe Target
