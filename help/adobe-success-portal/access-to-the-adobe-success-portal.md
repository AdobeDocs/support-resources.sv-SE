...
1. Välj ikonen **[!UICONTROL Success portal (Alpha)]**.
   ...
   ![Ikon och etikett för portalen Slutfört (alpha)](assets/alpha-success-portal-alpha.png "Kom åt portalen Slutfört (alpha)")



1. När du har loggat in ser du fem flikar:

   ![Sidofältet i Adobe Success Portal-gränssnittet](assets/adobe-success-portal-tabs.png "Sidofältsflikar")
...
![Knappen Alpha-feedback på portalen för att skicka feedback](assets/adobe-success-portal-home.png "Knappen Alpha-feedback")
