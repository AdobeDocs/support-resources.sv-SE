...
När du har valt **[!UICONTROL Open a support ticket]** eller **[!UICONTROL Open Ticket]** visas sidan där du skapat ärendet.

Formuläret använder ett guidat flerstegsarbetsflöde:

* Välj den berörda Adobe-produkten
* Beskriv problemet
* Ange system- och miljöinformation
* Ange påverkan och skyndsamhet
* Bekräfta kontaktinformation
* Granska och skicka in informationen
...
1. Klicka på produktnamnet för att välja den berörda produkten och klicka sedan på **[!UICONTROL Next]**.
   ...
   ![Experience Leag Välj en produkt](./assets/select-product.png)

1. I avsnittet **[!UICONTROL Issue Details]** anger du falltitel, beskriver problemet och anger hur du vill återskapa.

   ![Information om Experience Leag-problem](./assets/issue-details.png)

   Inkludera information som:

   * Vad du försöker göra
   * Vad fungerar inte som väntat
   * Alla senaste miljöändringar
   * Steg som du redan har vidtagit

   När du anger information om ett problem visar Experience League AI-baserade rekommendationer på en panel bredvid formuläret. Dessa rekommendationer:
...
1. I avsnittet **[!UICONTROL System Information]** markerar du miljön och klickar på **[!UICONTROL Next]**.
...
1. I avsnittet **[!UICONTROL Impact]** väljer du följande:
   * Ärendeprioritet (P4 - mindre, P3 - viktigt, P2 - brådskande, P1 - kritiskt)
   * Affärspåverkan (liten, Medium, stor)

   ![Information om påverkan av Experience Leag](./assets/impact.png)
...
1. I avsnittet **[!UICONTROL Contact Information]** väljer du tidszon, anger ditt telefonnummer, lägger till övervakare, bifogar eventuella filer och klickar sedan på **[!UICONTROL Next]**.

   ![Upplev kontaktinformation från Experience Leag](./assets/contact-information.png)

1. Granska din ärendeinformation i avsnittet **[!UICONTROL Review & Submit]** och klicka på **[!UICONTROL Submit]**.

   ![Utforska granskning och sändning av följeslagare](./assets/review-and-submit.png)
