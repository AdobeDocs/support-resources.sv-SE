...
1. Om användaren redan har ett Adobe-konto men inte kan logga in ber du användaren att skicka en [supportförfrågan](https://experienceleague.adobe.com/home#support) med [!UICONTROL Issue Reason] inställd på *Användarhantering*.
