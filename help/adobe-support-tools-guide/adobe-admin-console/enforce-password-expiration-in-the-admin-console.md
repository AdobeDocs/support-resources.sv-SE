---
title: Använd förfallodatum för lösenord i Admin Console
description: Lär dig hur systemadministratörer kan ange en tidsgräns för när lösenord ska förfalla för användare i Adobe Admin Console.
...
1. Gå till avsnittet [Adobe Admin Console](https://adminconsole.adobe.com/settings) **[!UICONTROL Settings]** och utöka alternativet **[!UICONTROL Privacy and security]** uppe till vänster.

1. Välj **[!UICONTROL Authentication settings]**.
