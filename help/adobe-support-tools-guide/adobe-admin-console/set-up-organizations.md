...
Ändringar loggas i granskningsloggen, alla användare meddelas via e-post och namnet kan inte uppdateras igen på 24 timmar. [Lär dig hur du visar och hämtar granskningsloggar](https://experienceleague.adobe.com/sv/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/download-audit-logs-and-export-reports).

## Ändra överordnad för en organisation

Som [[!DNL Global Administrator]](https://experienceleague.adobe.com/sv/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/manage-administrators) kan du reparera en organisation i organisationshierarkin med knappen **[!UICONTROL Change hierarchy]**.
...
Som [global administratör](https://experienceleague.adobe.com/sv/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/manage-administrators) kan du lägga till befintliga organisationer som för närvarande inte ingår i din Global Admin Console-hierarki i organisationshierarkin.
