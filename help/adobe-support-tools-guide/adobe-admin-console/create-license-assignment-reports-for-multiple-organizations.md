...
1. Välj **[!UICONTROL License Assignment]** på sidan **[!UICONTROL Create report]**.
1. Markera organisationerna och välj **[!UICONTROL Next]**. Du kan välja varje organisation separat eller välja alla underordnade organ inom en överordnad med knappen **[!UICONTROL Select all]**.
...
1. Välj de produkter som ska inkluderas i rapporten och välj **[!UICONTROL Next]**.
...
1. Välj om rapporten ska sammanställas per månad eller år.
1. Välj ett anpassat datumintervall eller välj bland förinställda alternativ. Du kan välja valfritt startdatum från 18 juni 2020 fram till föregående dag, så länge det inte föregår avtalets startdatum.
1. Välj **[!UICONTROL Download]** om du vill exportera rapporten som en CSV-fil.
